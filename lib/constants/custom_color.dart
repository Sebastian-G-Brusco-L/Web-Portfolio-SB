...
class CustomColor {
  ...
  static const Color bgLight3 = Color(0xff5a5e6f);
  static const Color textFieldBg = Color(0xffC8C9CE);
  static const Color hinDark = Color(0xff666874);
  static const Color yellowSecundary = Color(0xffFFC25C);
  ...
  static const Color metalicGold = Color(0xffD4AF37);
}
